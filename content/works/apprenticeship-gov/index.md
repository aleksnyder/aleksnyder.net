...
## Project Overview
Apprenticeship.gov is the Department of Labor's one-stop place for all things apprenticeship.  Whether it's prospective apprentices
...
{{< sidebyside left="app_gov_single_event.jpg" right="app_gov_events.jpg" alt="List of Events previously held by the Office of Apprenticeship" >}}
...
new feature, section, or initiative.

Once a direction was chosen, I would develop the back-end, front-end, and facilitate the launch of the feature, section, or initiative
following the requirement(s) given by the team.